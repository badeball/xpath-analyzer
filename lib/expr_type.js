...
export const NODE_NAME_TEST = "node-name-test";
export const NODE_TYPE_TEST = "node-type-test";
export const PROCESSING_INSTRUCTION_TEST = "processing-instruction-test";
